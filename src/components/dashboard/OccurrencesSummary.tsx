...
export function OccurrencesSummary({ occurrences }: OccurrencesSummaryProps) {
  ...
  return (
    <div className="p-6 bg-white rounded-2xl border border-black/5 shadow-sm space-y-4">
      <h3 className="text-sm font-medium text-triart-gray">Ocorrencias em Aberto</h3>

      <div className="grid grid-cols-3 gap-3">
        <div className={cn("p-4 rounded-xl text-center", extremas.length > 0 ? "bg-red-50" : "bg-gray-50")}>
        ...
        <div className={cn("p-4 rounded-xl text-center", medias.length > 0 ? "bg-yellow-50" : "bg-gray-50")}>
        ...
        <div className={cn("p-4 rounded-xl text-center", leves.length > 0 ? "bg-blue-50" : "bg-gray-50")}>
